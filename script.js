...
const translations = {
    en: {
        ...
        "q14-label": "12️⃣ Would you like to become a Beta User (the first to use the app)?",
        "beta-opt1": "Yes",
        "beta-opt2": "No",
    ...
    ur: {
        ...
        "q14-label": "12️⃣ کیا آپ بیٹا یوزر بننا چاہیں گے (جو سب سے پہلے ایپ استعمال کریں)؟",
        "beta-opt1": "ہاں",
        "beta-opt2": "نہیں",
    ...
    hi: {
        ...
        "q14-label": "12️⃣ क्या आप बीटा उपयोगकर्ता बनना चाहेंगे (जो सबसे पहले ऐप का उपयोग करें)?",
        "beta-opt1": "हाँ",
        "beta-opt2": "नहीं",
    ...
    ro: {
        ...
        "q14-label": "12️⃣ Kya aap Beta User banna chaheinge (jo sab se pehle app use karein)?",
        "beta-opt1": "Haan",
        "beta-opt2": "Nahin",
